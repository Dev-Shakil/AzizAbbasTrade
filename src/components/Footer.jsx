...
const Footer = () => {
  return (
    <footer className="bg-[#2e213e] text-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <span className="self-center md:text-3xl text-2xl font-semibold whitespace-nowrap dark:text-white">AZIZ ABBAS TRADE</span><span className="self-end text-xs md:text-base">Govt. Approved Recruiting Agency</span><span className="self-end text-xs md:text-base">License No. RL - 2116</span>
    </Link>
              </button>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-300 sm:text-center dark:text-gray-400">© 2023 <button className="hover:underline">Aziz Abbas Trade</button>. All Rights Reserved.
          </span>
