...
const HeroSection1 = ({data}) => {
  ...
  return (
    ...
    <h2 className="text-white text-3xl md:text-5xl  lg:text-6xl xl:text-8xl font-bold text-shadow pb-5 brightness-200 text-center drop-shadow-lg shadow-black">{data[currentState]?.title}</h2>
    <h3 className="text-white  md:text-2xl lg:text-4xl font-semibold">{data[currentState]?.description}</h3>
